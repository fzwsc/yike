...
<style>
	...
	.notice-comment .comments-item {
		padding: 31upx 31upx 30upx 30upx;
		margin-bottom: 20upx;
		background: #FFFFFF;
	}

	.notice-comment .comments-item .user-info {
		display: flex;

	}

	.notice-comment .comments-item .user-info .pic {
		display: block;
		width: 100upx;
		height: 100upx;
		margin-right: 10upx;
	...
	.notice-comment .comments-item .user-info .user-name {
		color: #333333;
		font-size: 28upx;
	}

	.notice-comment .comments-item .user-info .content {
		margin-top: 10upx;
		font-size: 30upx;
	}

	.notice-comment .comments-item .user-state {
		display: flex;
		margin-top: 30upx;

	}

	.notice-comment .comments-item .user-state .play-num {
		display: flex;
		align-items: center;

	}

	.notice-comment .comments-item .user-state .text {
		font-size: 20upx;
		color: #666666;
	}

	.notice-comment .comments-item .user-state .timer {
		flex: 1;
		display: flex;
		align-items: center;
		margin-left: 52upx;
	...
	.notice-comment .comments-item .user-state .time {
		font-size: 20upx;
		color: #666666;
	}

	.notice-comment .comments-item .user-state .pic {
		display: block;
		width: 28upx;
		height: 28upx;
		margin-right: 10upx;
	...
	.notice-comment .comments-item .notice {
		display: flex;
		align-items: center;
		margin-top: 39upx;
	}

	.notice-comment .comments-item .notice .pic {
		width: 32upx;
		height: 27upx;
		margin: 0 10upx;
	}
